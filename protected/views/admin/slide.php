              ...
              <div class="box">
                ...
                <div style="margin-left: 10px;">
                	...
                	<div ng-show="showInsert==1 || showInsert==2">
		                ...
		                <input style="float: left;width: 200px;"  type="text" class="form-control" name="Caption"  placeholder="Nhập Caption" ng-model="Caption"  >
		               
						<input style="float: left;width: 200px;"  type="text" class="form-control" name="Link"  placeholder="Nhập Link" ng-model="Link"  >

						<input style="float: left;width: 200px;"  type="text" class="form-control" name="Active"  placeholder="Active..." ng-model="Active"  >
				...
				<table class="table table-bordered table-hover">
					...
					<tbody>
						<tr ng-repeat="pro in products">
							<td><a style="cursor: pointer;" ng-click="UpdsNganh(pro.ID,pro.Caption,pro.Link,pro.Active)">{{pro.ID}}</a></td>
							<td>{{pro.Caption}}</td>
							<td>{{pro.Link}}</td>
							<td>{{pro.Active}}</td>
